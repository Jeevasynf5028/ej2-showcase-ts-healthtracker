...
function LoadCardData(): void {
    GetCardData().then((data: any) => {
        (document.getElementById('calories-text') as HTMLElement).textContent = data['calories-eaten'];
        (document.getElementById('steps-text') as HTMLElement).textContent = data['steps-taken'];
        (document.getElementById('water-text') as HTMLElement).textContent = data['water-consumed'];
        (document.getElementById('sleep-text') as HTMLElement).textContent = data['sleep-duration'];
        document.querySelectorAll('#card-row .row .card-skeleton').forEach((elem: Element) => (elem as HTMLElement).style.display = 'none');
        document.querySelectorAll('#card-row .row .e-card').forEach((elem: Element) => (elem as HTMLElement).style.display = 'flex');        
...
function BindCardClick(): void{
    (document.getElementById("water") as HTMLElement).onclick = function () {
        (document.querySelector('#polar #pie-title') as HTMLElement).innerHTML = 'Sunday Activity';
        (document.querySelector("#card-row .selected") as HTMLElement).classList.remove("selected");
        (document.querySelector("#card-row #water") as HTMLElement).classList.add("selected");
        waterclick();
    };
    (document.getElementById("step") as HTMLElement).onclick = function () {
        (document.querySelector('#multiple-donut #pie-title') as HTMLElement).innerHTML = 'Sunday Activity';
        (document.getElementById("chart-title") as HTMLElement).innerHTML = 'Steps Count';
        (document.querySelector("#card-row .selected") as HTMLElement).classList.remove("selected");
        (document.querySelector("#card-row #step") as HTMLElement).classList.add("selected");
        animation = true;
        stepclick();
    };
    (document.getElementById("sleep") as HTMLElement).onclick = function () {
        (document.getElementById("chart-title") as HTMLElement).innerHTML = 'Sleep Tracker';
        (document.querySelector("#card-row .selected") as HTMLElement).classList.remove("selected");
        (document.querySelector("#card-row #sleep") as HTMLElement).classList.add("selected");
        sleepclick();
    };
    (document.getElementById("calories") as HTMLElement).onclick = function () {
        (document.getElementById("chart-title") as HTMLElement).innerHTML = 'Calories Consumed';
        (document.querySelector("#card-row .selected") as HTMLElement).classList.remove("selected");
        (document.querySelector("#card-row #calories") as HTMLElement).classList.add("selected");
        caloriesclick();
    };
}
...
function InitializeCaloriesComponent(): void {
    ...
    let mouseclick: EmitType<IMouseEventArgs> = (args: IMouseEventArgs) => {
        ...
        if (getElement(linechartObj.element.id + '_Series_' + index.series + '_Point_' + index.point + '_Symbol')) {
            ...
            pieChartObj.series[0].animation!.enable = false;
    ...
    pieChartObj = new AccumulationChart({
        ...
        tooltip: { enable: true, format: '${point.x} : <b>${point.y}g</b>' }
    });
    pieChartObj.appendTo('#account-balance');
    pieChartObj.refresh();
    /* tslint:eanble */
    linechartObj = new Chart({
        ...
        loaded: (args: ILoadedEventArgs) => {
            (document.getElementById("Break-icon") as HTMLElement).onclick = function () {
...
function InitializeStepsComponent(): void {
                ...
                series: [
                    {
                        ...
                        explode: false, explodeOffset: '10%', animation:{enable: animation}
                    }
                ],
                enableBorderOnMouseMove: false,
                enableSmartLabels: true,
    ...
    linechartObj = new Chart({
        ...
        annotations: [{
            content: '<div id="thumbs_up"><span id="achieved-img" class="icon-achieved" style="font-size: 36px; color: #06d417;"></span></div>',
...
function InitializeWaterComponent(): void {
    ...
    polarChartObj.appendTo('#water-polar');
    (document.getElementById("water50ml-column") as HTMLElement).onclick = function () {
        (document.getElementById("water50ml-column") as HTMLElement).style.backgroundImage = 'linear-gradient(to right, #2140DC, #00BFD5)';
        (document.getElementById("water100ml-column") as HTMLElement).style.backgroundImage = "";
        (document.getElementById("water200ml-column") as HTMLElement).style.backgroundImage = "";
        (document.getElementById("water300ml-column") as HTMLElement).style.backgroundImage = "";
        ...
        (document.getElementById("imgtext3") as HTMLElement).style.color = '#5B5B5B';
        (document.getElementById("imgtext4") as HTMLElement).style.color = '#5B5B5B';
        (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y = (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y + 0.05;
        polarChartObj.series[0].animation!.enable = false;
    ...
    document.getElementById("water100ml-column")!.onclick = function () {
        ...
        (document.getElementById("imgtext4") as HTMLElement).style.color = '#5B5B5B';
        polarChartObj.series[0].animation!.enable = false;
        (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y = (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y + 0.1;
        polarChartObj.enableAnimation = false;
        polarChartObj.appendTo('#water-polar');
    }
    document.getElementById("water200ml-column")!.onclick = function () {
        ...
        (document.getElementById("imgtext4") as HTMLElement).style.color = '#5B5B5B';
        polarChartObj.series[0].animation!.enable = false;
        (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y = (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y + 0.2;
        polarChartObj.appendTo('#water-polar');
    }
    document.getElementById("water300ml-column")!.onclick = function () {
        ...
        (document.getElementById("imgtext1") as HTMLElement).style.color = '#5B5B5B';
        polarChartObj.series[0].animation!.enable = false;
        (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y = (<{[key:string]:number}[]>polarChartObj.series[0].dataSource)[pointindex].y + 0.5;
        polarChartObj.appendTo('#water-polar');
    }
    polarChartObj.refresh();
...
function waterclick(): void {
    ...
    (document.getElementById("iconml2-img") as HTMLElement).style.color = '#5B5B5B';
    (document.getElementById("iconml3-img") as HTMLElement).style.color = '#5B5B5B';
    (document.getElementById('sleep-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 sleep-value card-container';
    (document.getElementById('step-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 steps-value card-container';
    (document.getElementById('calories-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 calories-value card-container';
    (document.getElementById('water-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 water-valueactive card-container';
    ...
    (document.getElementById('chart-header-title') as HTMLElement).innerHTML = '<span id="chart-title"> Water Consumption </span>';
    (document.getElementById('total-value') as HTMLElement).innerHTML = '<span id="title-annotation"> Target </span><span id="value-annotation" style="color: #3B61E9;"> 7 litres </span>';
    (document.getElementById("average-value") as HTMLElement).innerHTML = '<span id="title-annotation"> Daily Average </span><span id="value-annotation" style="color: #3B61E9;"> 4.32 litres </span>';
    LoadChartData("water");
}
...
function stepclick(): void {
    ...
    ToggleVisibility('block', 'none');
    (document.getElementById('sleep-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 sleep-value card-container';
    (document.getElementById('step-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 steps-valueactive card-container';
    (document.getElementById('calories-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 calories-value card-container';
    (document.getElementById('water-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 water-value card-container';
    ...
    (document.getElementById('chart-header-title') as HTMLElement).innerHTML = '<span id="chart-title"> Steps Taken </span>';
	(document.getElementById('total-value') as HTMLElement).innerHTML = '<span id="title-annotation"> Distance Travelled </span><span id="value-annotation" style="color:#05AD13"> 3.2 miles </span>';
	(document.getElementById("average-value") as HTMLElement).innerHTML = '';
    LoadChartData("steps");
}
...
function sleepclick() {
    annotation = false;
    ToggleVisibility('block', 'none');
    (document.getElementById('sleep-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 sleep-valueactive card-container';
    (document.getElementById('step-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 steps-value card-container';
    (document.getElementById('calories-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 calories-value card-container';
    (document.getElementById('water-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 water-value card-container';
    (document.getElementById("multiple-donut") as HTMLElement).style.display = 'none';
    ...
    (document.getElementById("polar") as HTMLElement).style.display = 'none';
    (document.getElementById('chart-header-title') as HTMLElement).innerHTML = '<span id="chart-title"> Sleep Tracker </span>';
    (document.getElementById('total-value') as HTMLElement).innerHTML = '<span id="title-annotation"> Goal </span><span id="value-annotation" style="color:#4526A6"> 7.2 hrs </span>';
    (document.getElementById("average-value") as HTMLElement).innerHTML = '<span id="title-annotation"> Daily Average </span><span id="value-annotation" style="color:#4526A6"> 6.32 hrs </span>';
    LoadChartData("sleep");
...
function caloriesclick() {
    ...
    (document.getElementById('sleep-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 sleep-value card-container';
    (document.getElementById('step-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 steps-value card-container';
    (document.getElementById('calories-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 calories-valueactive card-container';
    (document.getElementById('water-column') as HTMLElement).className = 'col-xs-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 water-value card-container';
    (document.getElementById("multiple-donut") as HTMLElement).style.display = 'none';
    (document.getElementById("donut") as HTMLElement).style.display = 'block';
    (document.getElementById("semi-pie") as HTMLElement).style.display = 'none';
    (document.getElementById("polar") as HTMLElement).style.display = 'none';
    (document.getElementById('chart-header-title') as HTMLElement).innerHTML = '<span id="chart-title"> Calories Consumed </span>';
    (document.getElementById('total-value') as HTMLElement).innerHTML = '<span id="title-annotation"> Total </span><span id="value-annotation" style="color:#780508">1437 Kcal</span>';
    (document.getElementById("average-value") as HTMLElement).innerHTML = '<span id="title-annotation"> Daily Average </span><span id="value-annotation" style="color:#DB4247"> 902 Kcal </span>';
    LoadChartData("calorie");
}